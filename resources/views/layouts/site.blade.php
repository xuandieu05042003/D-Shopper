...
<body>
                    ...
                    <div class="col-sm-6">
                        <div class="contactinfo">
                            <ul class="nav nav-pills">
                                <li><a href="#"><i class="fa fa-phone"></i> +84 338365543</a></li>
                                <li><a href="#"><i class="fa fa-envelope"></i> dieunx0504@gmail.com</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav">
                                <li><a href="http://127.0.0.1:8000/admin/auth/login"><i class="fa fa-user"></i>
                                        Admin</a></li>
    ...
    <footer id="footer">
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    <p class="pull-left">Copyright © 2013 D-SHOPPER Inc. All rights reserved.</p>
